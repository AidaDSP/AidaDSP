...
int32_t param9_pulses = 119; // thr = 1.0
int32_t param10_pulses = 119; // thr = 1.0
int32_t oldparam9_pulses = 119;
int32_t oldparam10_pulses = 119;
...
void setup()
{
  ...
  param9_value = processencoder(0.01, 1.0, param9_pulses); // Hard Clip 1
  param10_value = processencoder(0.01, 1.0, param10_pulses); // Hard Clip 2
  ...
  hard_clip(DEVICE_ADDR_7bit, HardClip1Addr, param9_value, -param9_value); // Set Hard Clip 1
  delayMicroseconds(100);
  
  hard_clip(DEVICE_ADDR_7bit, HardClip2Addr, param10_value, -param10_value); // Set Hard Clip 2
  delayMicroseconds(100);
...
void loop()
{
  ...
  { 
    ...
    case 8: // Soft Clip 1
      ...
      if(param9_pulses != oldparam9_pulses)
      {
        param9_value = processencoder(0.01, 1.0, param9_pulses); // Hard Clip 1
        hard_clip(DEVICE_ADDR_7bit, HardClip1Addr, param9_value, -param9_value); // Set Hard Clip 1
        oldparam9_pulses = param9_pulses;
      }
      break;
    case 9: // Soft Clip 2
      if(restore)
      ...
      if(param10_pulses != oldparam10_pulses)
      {
        param10_value = processencoder(0.01, 1.0, param10_pulses); // Hard Clip 2
        hard_clip(DEVICE_ADDR_7bit, HardClip1Addr, param10_value, -param10_value); // Set Hard Clip 2
        oldparam10_pulses = param10_pulses;
      }
      break;  
...
void print_menu_putty(void)
{
  ...
  Serial.println(param9_value, 1);
  if(func_counter==9)
    Serial.print(F("    "));
  Serial.print(F("Dist 2: "));
  Serial.println(param10_value, 1);
  if(func_counter==10)
    Serial.print(F("    "));
